...
class ReportDeatilActivity : AppCompatActivity() {
    ...
    private fun saveReport() {
        ...
        var appReport=AppReport(key,tv_android_version.text.toString(),tv_app_version.text.toString()
            ,tv_phone_model.text.toString(),currentDate,et_reportdetail.text.toString(),selectedRadio.text.toString(),name)

        databaseReference!!.child(app_name.toString()).child(databaseReference!!.push().key.toString()).setValue(appReport)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       // var intent=Intent()
        ...
        databaseReference!!.child(app_name.toString()).child("version").addListenerForSingleValueEvent(object:ValueEventListener{
